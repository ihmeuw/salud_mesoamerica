...
// September 2022 - IHME
// Nicaragua Performance Indicator 4080
...
***************************************
 ...
 // MATERNAL COMPLICATIONS RECORDS (4080)
	use "IHME_SMI_NIC_HFS_2022_MATCOMP_Y2023M08D17.dta", clear
...
// APPROPRIATAE TREATMENT
	...
	//BASIC: laparotomía o salpinguectomia o reparacion quirúrgica o traslado a CONE completo 
	...
	//BASIC: cesárea o traslado a CONE completo
	replace hem_treat_previa = 0 if ( hem_previa == 1 | hem_previa2 == 1 ) & hem_csec !=. & wom_hem_result !=. & wom_hem_disposition !=. & cone == "basic"
	replace hem_treat_previa = 1 if ( hem_previa == 1 | hem_previa2 == 1 ) & ( hem_csec == 1 | wom_hem_result == 2 | wom_hem_result == 3 | wom_hem_disposition == 3 ) & cone == "basic"
	//COMP: cesárea
	...
	gen hem_treat_desp = .
	//BASIC: parto vaginal o cesárea o traslado a CONE completo 
	replace hem_treat_desp = 0 if ( hem_premature == 1 | hem_placenta == 1 ) & hem_csec !=. & wom_hem_result !=. & wom_hem_disposition !=. & cone == "basic"
	replace hem_treat_desp = 1 if ( hem_premature == 1 | hem_placenta == 1 ) & ( hem_csec == 1 | wom_hem_result == 1 | wom_hem_result == 2 | wom_hem_result == 3 | wom_hem_disposition == 3 ) & cone == "basic"
	...
	//BASIC: laparotomía o histerectomia o reparacion quirurgica o cesárea o traslado a CONE completo
	replace hem_treat_rupture = 0 if hem_rupture == 1 & hem_lap !=. & hem_hist !=. & hem_surg !=. & hem_csec !=. & wom_hem_result !=. & wom_hem_disposition !=. & cone == "basic"
	replace hem_treat_rupture = 1 if hem_rupture == 1 & ( hem_lap == 1 | hem_hist == 1 | hem_surg == 1 | hem_csec == 1 | wom_hem_result == 2 | wom_hem_result == 3 | wom_hem_disposition == 3 ) & cone == "basic"
	//COMP: laparotomía o histerectomia o reparacion quirurgica o cesárea 
	replace hem_treat_rupture = 0 if hem_rupture == 1 & hem_lap !=. & hem_hist !=. & hem_surg !=. & hem_csec !=. & wom_hem_result !=. & cone == "comp"
	replace hem_treat_rupture = 1 if hem_rupture == 1 & ( hem_lap == 1 | hem_hist == 1 | hem_surg == 1 | hem_csec == 1 | wom_hem_result == 2 | wom_hem_result == 3 ) & cone == "comp"
	
	//Atonía uterina
	gen hem_treat_atony = .
	//BASIC: uterotonico (oxitocina o misoprostol o metilergonovina) + [masaje uterino o compresión bimanual o compresión de la aorta o taponmiento uterino (balón hidrostático) o suturas compresivas o histerectomía o traslado a CONE completo] 
	replace hem_treat_atony = 0 if hem_atony == 1 & hem_oxi !=. & hem_miso !=. & hem_metr !=. & hem_masaje !=. & hem_biman !=. & hem_aorta !=. & hem_tap !=. & hem_suture2 !=. & hem_hist !=. & wom_hem_disposition !=. & cone == "basic"
	replace hem_treat_atony = 1 if hem_atony == 1 & ( hem_oxi == 1 | hem_miso == 1 | hem_metr == 1 ) & ( hem_masaje == 1 | hem_biman == 1 | hem_aorta == 1 | hem_tap == 1 | hem_suture2 == 1 | hem_hist == 1 | wom_hem_disposition == 3 ) & cone == "basic"
	//COMP: uterotonico (oxitocina o misoprostol o metilergonovina) + [masaje uterino o compresión bimanual o compresión de la aorta o taponmiento uterino (balón hidrostático) o suturas compresivas o histerectomía]
	...
	//Inversión uterina
	gen hem_treat_inv = .
	//BASIC: uterotonico (oxitocina o misoprostol o metilergonovina) + [reposición o restitución del útero bajo sedación o anestésicos disponibles en el servicios y técnicas no quirúrgicas (maniobra de Johnson) o quirúrgicas (maniobras de Huntington o de Haultani) o traslado a CONE completo]
	replace hem_treat_inv = 0 if hem_inversion == 1 & hem_oxi !=. & hem_miso !=. & hem_metr !=. & hem_rep !=. & (wom_hem_reposition_sed !=. & hem_rep == 1) & hem_hist !=. & wom_hem_disposition !=. & cone == "basic"
	...
	replace hem_treat_inv = 0 if hem_inversion == 1 & hem_oxi !=. & hem_miso !=. & hem_metr !=. & hem_rep !=. & (wom_hem_reposition_sed !=. & hem_rep == 1) & cone == "comp"
	...
	//BASIC: uterotonico (oxitocina o misoprostol o metilergonovina) + [extracción manual o legrado o laparotomía o histerectomía o traslado a CONE completo]
	replace hem_treat_placenta = 0 if ( hem_retain == 1 | hem_retainpart == 1 | hem_restos == 1 | hem_placent == 1 ) & hem_oxi !=. & hem_miso !=. & hem_metr !=. & hem_manual !=. & hem_legrado !=. & hem_lap !=. & hem_hist !=. & wom_hem_disposition !=. & cone == "basic"
	replace hem_treat_placenta = 1 if ( hem_retain == 1 | hem_retainpart == 1 | hem_restos == 1 | hem_placent == 1 ) & ( hem_oxi == 1 | hem_miso == 1 | hem_metr == 1 ) & ( hem_manual == 1 | hem_lap == 1 | hem_legrado == 1 | hem_hist == 1 | wom_hem_disposition == 3 ) & cone == "basic"
	//COMP: uterotonico (oxitocina o misoprostol o metilergonovina) + [extracción manual o legrado o laparotomía o histerectomía]
	replace hem_treat_placenta = 0 if ( hem_retain == 1 | hem_retainpart == 1 | hem_restos == 1 | hem_placent == 1 ) & hem_oxi !=. & hem_miso !=. & hem_metr !=. & hem_manual !=. & hem_lap !=. & hem_legrado !=. & hem_hist !=. & cone == "comp"
	replace hem_treat_placenta = 1 if ( hem_retain == 1 | hem_retainpart == 1 | hem_restos == 1 | hem_placent == 1 ) & ( hem_oxi == 1 | hem_miso == 1 | hem_metr == 1 ) & ( hem_manual == 1 | hem_lap == 1 | hem_legrado == 1 | hem_hist == 1 ) & cone == "comp"
...
// Shorten varnames here
	...
	foreach var in plat asp ala lac creat acid prot {
...
// CHECKS
	// BASIC: BP + pulse + respiratory rate
	gen pre_vitsigns = 0 if pre_bp !=. & pre_puls !=. & pre_hr !=. & pre_resp !=. & cone == "basic"
	replace pre_vitsigns = 1 if pre_bp == 1 & ( pre_puls == 1 | pre_hr == 1 ) & pre_resp == 1 & cone == "basic"
...
// LAB
	// BASIC: urine protein (if referral)
	gen pre_lab = 0 if pre_prot !=. & wom_pre_disposition == 3 & cone == "basic"
	replace pre_lab = 1 if pre_prot == 1 & wom_pre_disposition == 3 & cone == "basic"
	
	// BASIC (no referral) or COMPLETE: urine protein + platelets + creatine + uric acid + aspartato aminotransferasa/Transaminasa glutámico-oxalacética (TGO o GOT ) + alanina aminotransferasa/Transaminasa glutámico-pirúvica (TGP o GPT) + lactate dehydrogenase
	replace pre_lab = 0 if pre_prot !=. & pre_plat !=. & pre_creat !=. & pre_acid !=. & pre_asp !=. & pre_ala !=. & pre_lac !=. & ((wom_pre_disposition != 3 & cone == "basic") | cone == "comp" )
	replace pre_lab = 1 if pre_prot == 1 & pre_plat == 1 & pre_creat == 1 & pre_acid == 1 & pre_asp == 1 & pre_ala == 1 & pre_lac == 1 & ((wom_pre_disposition != 3 & cone == "basic") | cone == "comp" )

// MEDS - BASIC & COMPLETE: magnesium sulfate + hydralazine/labeltalol/nifedipine (if diastolic bp > 110)
	...
	gen pre_med = 0 if pre_mgs !=. 
	replace pre_med = 1 if pre_mgs == 1 & pre_hydra != 0 
...
//FINAL CALCULATION
	...
	replace pre_norm = 0 if pre_vitsigns !=. & pre_lab !=. & pre_med !=. 
	replace pre_norm = 1 if pre_vitsigns == 1 & pre_lab == 1 & pre_med == 1
}		

{ // ECLAMPSIA 4080 DEFINITION
...
// CHECKS
	// BASIC: BP + pulse + respiratory rate
	gen ecl_vitsigns = 0 if ecl_bp !=. & ecl_puls !=. & ecl_hr !=. & ecl_resp !=. & cone == "basic"
	replace ecl_vitsigns = 1 if ecl_bp == 1 & ( ecl_puls == 1 | ecl_hr == 1 ) & ecl_resp == 1 & cone == "basic"
...
// LAB
	// BASIC: urine protein (if referral)
	gen ecl_lab = 0 if ecl_prot !=. & wom_ecl_disposition == 3 & cone == "basic"
	replace ecl_lab = 1 if ecl_prot == 1 & wom_ecl_disposition == 3 & cone == "basic"
	
	// BASIC (no referral) or COMPLETE: urine protein + platelets + creatine + uric acid + aspartato aminotransferasa/Transaminasa glutámico-oxalacética (TGO o GOT ) + alanina aminotransferasa/Transaminasa glutámico-pirúvica (TGP o GPT) + lactate dehydrogenase
	replace ecl_lab = 0 if ecl_prot !=. & ecl_plat !=. & ecl_creat !=. & ecl_acid !=. & ecl_asp !=. & ecl_ala !=. & ecl_lac !=. & ((wom_ecl_disposition != 3 & cone == "basic") | cone == "comp" )
	replace ecl_lab = 1 if ecl_prot == 1 & ecl_plat == 1 & ecl_creat == 1 & ecl_acid == 1 & ecl_asp == 1 & ecl_ala == 1 & ecl_lac == 1 & ((wom_ecl_disposition != 3 & cone == "basic") | cone == "comp" )
...
// MEDS - BASIC & COMPLETE: magnesium sulfate + hydralazine/labeltalol/nifedipine (if diastolic bp > 110)
	...
	gen ecl_med = 0 if ecl_mgs !=. 
	replace ecl_med = 1 if ecl_mgs == 1 & ecl_hydra != 0 
...
//FINAL CALCULATION
	...
	replace ecl_norm = 0 if ecl_vitsigns !=. & ecl_lab !=. & ecl_med !=. 
	replace ecl_norm = 1 if ecl_vitsigns == 1 & ecl_lab == 1 & ecl_med == 1
}		

{ // SEPSIS 4080 DEFINITION
...
// Shorten varnames here
	...
	foreach var in abort abort2 perf corio pelvicabscess ectinfect pelviper canaltear epistoinfect postendo  {
...
//Manage antibiotics variables
	foreach var in ami cli gen amp met peni penicry pip taz ceftr {
	...
	replace sep_anti = 1 if sep_ami == 1 | sep_cli == 1 | sep_gen == 1 | sep_amp == 1 | sep_met == 1 | sep_peni == 1 | sep_penicry == 1 | sep_pip == 1 | sep_taz == 1 | sep_ceftr == 1 	| regex(wom_sep_med_oan1_name, "amoxi") | regex(wom_sep_med_oan1_name, "cefotax") | regex(wom_sep_med_oan1_name, "doxi")
...
//APPROPRIATE CARE
	...
	gen sep_treat_endo = .
	//BASIC + COMPLETE: antibiótico
	replace sep_treat_endo = 0 if sep_postendo == 1 & sep_anti !=.
	replace sep_treat_endo = 1 if sep_postendo == 1 & sep_anti == 1
	
	//Absceso pélvico
	gen sep_treat_abscess = .
	//BASIC: antibiótico + [drenaje o laparotomía o histerectomía o reparación quirúrgica o traslado a CONE completo]	
	replace sep_treat_abscess = 0 if sep_pelvicabscess == 1 & sep_anti !=. & sep_drenaje !=. & sep_lap !=. & sep_hist !=. & sep_surg !=. & wom_sep_disposition !=. & cone == "basic"
	replace sep_treat_abscess = 1 if sep_pelvicabscess == 1 & sep_anti == 1 & ( sep_drenaje == 1 | sep_lap == 1 | sep_hist == 1 | sep_surg == 1 | wom_sep_disposition == 3 ) & cone == "basic"
	...
	gen sep_treat_reten = .
	//BASIC: antibiótico + [legrado o laparotomía o histerectomía o traslado a CONE completo]
	replace sep_treat_reten = 0 if sep_retain == 1 & sep_anti !=. & sep_legrado !=. & sep_lap !=. & sep_hist !=. & wom_sep_disposition !=. & cone == "basic"
	replace sep_treat_reten = 1 if sep_retain == 1 & sep_anti == 1 & ( sep_legrado == 1 | sep_lap == 1 | sep_hist == 1 | wom_sep_disposition == 3 ) & cone == "basic"
	...
	//Overall treatment
	gen sep_treatment = 1 if sep_treat_endo !=. | sep_treat_abscess !=. | sep_treat_reten !=.
	replace sep_treatment = 0 if sep_treat_endo == 0 | sep_treat_abscess == 0 | sep_treat_reten == 0
